...
public class Market {
    ...
    public static void urunListele() {//KONSOLDA ILK KARSIMIZSA CIKACAK EKRAN YAZISI
        System.out.println("No\t Ürünler \tFiyatlar");
        System.out.println("===\t ======== \t========");
        //BURADA FOR  urunlerin ve fiyatlarin tamami konsolda cikacak
        for (int i = 0; i< urunler.size(); i++) {  // kullanici urun sececek
    ...
    public static double sepeteYazdir() {  /* konsol calistiginda urun no seceriz
                                           agirlik seceriz enter basinca bu kod calisir ( URUN NO2 agirlik 3)
                                           Ürün Adı 	KG 		Fiyatı
                                            =================================
                                                Biber	 	3.0		4.5
                                             =================================
...
//		System.out.printf("ÖDENECEK TOPLAM FİYAT: %.2f", toplamFiyat);
        ...
        }while(nakit < toplamFiyat); // normal while yukari yazilirdi   do while de asagi yazilir

/*
************************************
 ************* ÖDEME ***************
 ÖDENECEK TOPLAM FİYAT:77.0
 Lütfen Nakit Giriniz:50
 Girilen Rakam yetersiz.
 27.0 TL daha yatırmanız gerekmektedir.
 Lütfen Nakit Giriniz:*/
      ...
      ***********************************
      ************* ÖDEME ***************
           ÖDENECEK TOPLAM FİYAT:5.0
            Lütfen Nakit Giriniz:10
                PARA ÜSTÜ :5.0
              YİNE BEKLERİZ
              */
